...
public class ExpressionProcessorTest extends TestCase {
    ...
    public void test3() throws Exception {
        assertEquals((new ExpressionProcessor("((5 MOD 4) * 5 - -4 + (60 / 20) / (1 + 5))")).toString(), "9.50");
    }

    @Test
    public void test4() throws Exception {
        assertEquals((new ExpressionProcessor("((5 MOD 4) * 5 - 60 / 20 + 5)")).toString(), "7.00");
    }
    ...
    public void test9() throws Exception {
        assertEquals((new ExpressionProcessor("5 4 MOD 5 * -4 - 60 20 / 1 5 + / +")).toString(), "9.50");
    }

    @Test
    public void test10() throws Exception {
        assertEquals((new ExpressionProcessor("5 4 MOD 5 * 60 20 / - 5 +")).toString(), "7.00");
    }
    ...
    public void test15() throws Exception {
        assertEquals((new ExpressionProcessor("+ / - * MOD 5 4 5 -4 / 60 20 + 1 5")).toString(), "9.00");
    }

    @Test
    public void test16() throws Exception {
        assertEquals((new ExpressionProcessor("+ - * MOD 5 4 5 / 60 20 5")).toString(), "7.00");
    }
    ...
    public void test19() throws Exception {
        assertEquals((new ExpressionProcessor("3 5 < not true and")).toString(), "false");
    }
