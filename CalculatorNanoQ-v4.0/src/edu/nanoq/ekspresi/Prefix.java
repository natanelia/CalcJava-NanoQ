...
public class Prefix extends Postfix {
	...
	Prefix(String _ekspresi, String _operandType) {
        super(_operandType);
        ekspresiP = _ekspresi;
        convertToPost();
        super.Hitung();
    ...
    public String getEkspresi() { return ekspresiP; } //mengembalikan string ekspresi prefix

    public void printEkspresi() { System.out.println(getEkspresi());} //mencetak string ekspresi prefix ke layar
}
